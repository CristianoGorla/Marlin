...
#define STRING_CONFIG_H_AUTHOR "(Bio80, SKR 3)" // Who made the changes.
 ...
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 80, 80, 400, 420.08 }
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET { 0, -40, -2.888 }
